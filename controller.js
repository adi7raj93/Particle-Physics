...
/* {Object} event and returns {Array} the simulation coodinates from the
event */
...
/* {Array|ArrayBufferView|value} value
{number} [precision=4]
returns {Array|number} a copy of the array/value rounded to
PRECISION */
